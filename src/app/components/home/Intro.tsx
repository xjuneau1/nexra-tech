export default function Intro() {
  return (
    <div className="col-span-1 sm:col-span-1 md:col-span-2 flex justify-center items-start min-h-max md:my-32 md:px-16">
      <div className="bg-gradient-to-br from-[#1a1a40] to-[#3a0ca3] text-white p-12 rounded-2xl shadow-lg w-11/12">
